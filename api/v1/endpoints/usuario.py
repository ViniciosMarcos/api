...
from schemas.usuario_schema import UsuarioSchemaBase, UsuarioSchemaArtigo, UsuarioSchemaCreate, UsuarioSchemaUp
...
# GET Usuario
@router.get('/{usuario_id}', response_model=UsuarioSchemaArtigo)
async def get_usuario(usuario_id: int, db: AsyncSession = Depends(get_session)):
    async with db as session:
        ...
        if usuario:
            ...
            raise HTTPException(detail='Usuaior nao encontrado',
