...
# GET Aritgo
@router.get('/{artigo_id}', response_model=List[ArtigoSchema], status_code=status.HTTP_200_OK)
...
# PUT Artigo
@router.put('/{artigo_id}', response_model=List[ArtigoSchema], status_code=status.HTTP_202_ACCEPTED)
